...
class Ordersummaryserializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'date', 'invoice_no', 'deliveryzone', 'payment_mode', 'product_cost', 'coupon', 'discount', 'free_delivery', 'grand_total', 'total_profit', 'order_status', 'is_combo', 'combo_name', 'combo_quantity', 'payment_status', 'orderitems_ordersummary', 'order_note']
