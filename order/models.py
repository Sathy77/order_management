...
class Ordersummary(Basic):
    ...
    deliveryzone = models.OneToOneField(MODELS_ZONE.Deliveryzone, on_delete=models.SET_NULL, blank=True, null=True, related_name='ordersummary_deliveryzone')
    payment_mode = models.CharField(max_length=20, choices=CHOICE.PAYMENT_MODE, blank=True, null=True, default=CHOICE.PAYMENT_MODE[0][1])
